...
defmodule CommunityGarden do
  @moduledoc """
  The Agent module abstracts spawning processes and the receive-send loop. Agent processes are processes started by an agent.
  They can be used to share a central state.
  """
  def start() do
  ...
  def release(pid, plot_id) do
    Agent.cast(pid, fn %{plots: plots} = status ->
      plots = Enum.reject(plots, fn %{plot_id: p} -> p === plot_id
    end)
